...
func ORCheck(paper *Paper, acceptanceModel *AcceptanceModel) bool {
    ...
    case "4", "5" :
        if paper.Status != "under_decision" && paper.Status != "revise" && paper.Status != "accepted" && paper.Status != "rejected" {
            open = false
        }
...
func GetPaperByte (stub shim.ChaincodeStubInterface, paperKey string) ([]byte, error) {
    ...
    paperByte, err = InvokeChaincode(stub, "test_paper", "QueryPaper", []string { paperKey })
    if err != nil {
...
func GetAcceptanceModel (stub shim.ChaincodeStubInterface, organization string) (*AcceptanceModel, error) {
    ...
    acceptanceModelByte, err = InvokeChaincode(stub, "test_acceptanceModel", "QueryAcceptanceModel", []string { organization })
    if err != nil {
        return nil, errors.New(function + " : " + err.Error())
    }
...
//    }
    ...
    reviewersByte, err = InvokeChaincode(stub, "test_reviewer", "QueryReviewerWithPaperKey", []string { paperKey })
    if err != nil {
        return -1, errors.New(function + " : " + err.Error())
    }
...
func CreateSignatureKeyWithContractKey(stub shim.ChaincodeStubInterface, contractKey string, reviewerKey string) (string, error) {
    ...
    signatureKey, err := stub.CreateCompositeKey("SIG", []string { splitContractKey[0], splitContractKey[1], splitContractKey[2], reviewerKey })
    if err != nil {
        return "", errors.New(function + " : " + err.Error())
    }
...
func ConvertReviewerKey(stub shim.ChaincodeStubInterface, Key string, reviewerKey string) (string, error) {
    ...
    if docType == "PR" || docType == "OI" {
        newReviewerKey, err := stub.CreateCompositeKey("RP", []string { reviewerKey, splitKey[0], splitKey[1] })
        if err != nil {
            return "", errors.New(function + " : " + err.Error())
        }
...
func ConvertCommentKey(stub shim.ChaincodeStubInterface, commentKey string, reviewerKey string) (string, error) {
    ...
    if docType == "CR" {
        newCommentKey, err := stub.CreateCompositeKey("RC", []string { reviewerKey, splitCommentKey[0], splitCommentKey[1], splitCommentKey[2], splitCommentKey[3] })
        if err != nil {
            return "", errors.New(function + " : " + err.Error())
        }
...
func ConvertRatingKey(stub shim.ChaincodeStubInterface, Key string, reviewerKey string) (string, error) {
    ...
    if docType == "PR" || docType == "OI" {
        newRatingKey, err := stub.CreateCompositeKey("RP", []string { reviewerKey, splitKey[0], splitKey[1] })
        if err != nil {
            return "", errors.New(function + " : " + err.Error())
        }
...
func GetReviewerIndex(stub shim.ChaincodeStubInterface, reviewerKey string) (string, error) {
    ...
    if docType == "PR" {
        ...
        PRKeyBytes, err = InvokeChaincode(stub, "test_reviewer", "GetPRKey", []string { reviewerKey })
        if err != nil {
            return "", errors.New(function + " : " + err.Error())
        }
