...
//        //args[0] = reviewerID
//        case "QueryReviewerWithReviewerID", "QueryReviewPapers" :
...
//        //args[0] = paperKey
//        case "DeclineReview" :
//            err = CertifyROPWithPaperKey(stub, args[0])
//            if err == nil {
//                userType = SELF
//            } else {
//                return userType, errors.New("AccessControl"+ " : " + err.Error())
...
//                return target, nil
//            } else {
//                return target, errors.New("ApplyAcceptanceModel" + " : " + "accessControle Error, this user is not editor of paper")
//            }
//
//        case "QueryReviewerWithPaperKey" :
...
//                return buff.Bytes(), nil
//            } else {
//                return target, errors.New("ApplyAcceptanceModel" + " : " + "Certify Error")
//            }
//
...
//                return target, nil
//            } else {
//                return target, errors.New("ApplyAcceptanceModel" + " : " + "accessControle Error")
//            }
//
//        default :
...
func (s *SmartContract) RegisterReviewer(stub shim.ChaincodeStubInterface, args []string) error {
    ...
    if PRKeyByte == nil {
        ...
        reviewer = Reviewer { Key : PRKey, PaperKey : args[0], ReviewerID : identifier, Email : "", Status : "selected" }
        reviewerByte, err =  json.Marshal(reviewer)
        if err != nil {
            return errors.New(function + " : " + err.Error())
        }
...
func (s *SmartContract) SelectReviewer(stub shim.ChaincodeStubInterface, args []string) error {
    ...
    _, err = InvokeChaincode(stub, "test_paper", "UpdateStatus", []string { args[0], "reviewer_invited" })
    if err != nil {
        return errors.New(function + " : " + err.Error())
    }
