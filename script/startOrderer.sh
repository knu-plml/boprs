...
docker exec -itd $name mkdir -p /root/testnet/crypto-config/peerOrganizations/jistap/peers/peer0.jistap/tls/
docker exec -itd $name mkdir -p /root/testnet/crypto-config/peerOrganizations/jistap2/peers/peer2.jistap2/tls/
docker exec -itd $name cp /root/testnet/crypto-config/ordererOrganizations/$aff/orderers/${name}.${aff}/msp/cacerts/ca.crt /root/testnet/crypto-config/peerOrganizations/jistap/peers/peer0.jistap/tls/
docker exec -itd $name cp /root/testnet/crypto-config/ordererOrganizations/$aff/orderers/${name}.${aff}/msp/cacerts/ca.crt /root/testnet/crypto-config/peerOrganizations/jistap2/peers/peer2.jistap2/tls/

docker cp $name:/root/testnet/crypto-config/ordererOrganizations/$aff/orderers/$name.$aff/msp/tlscacerts/ca.crt ./${name}-tlsca.crt

docker exec -itd $name bash -c "ORDERER_GENERAL_LOGLEVEL=info \\
...
ORDERER_GENERAL_TLS_ROOTCAS=[/root/testnet/crypto-config/ordererOrganizations/${aff}/orderers/${name}.${aff}/msp/cacerts/ca.crt,/root/testnet/crypto-config/peerOrganizations/jistap/peers/peer0.jistap/tls/ca.crt,/root/testnet/crypto-config/peerOrganizations/jistap2/peers/peer2.jistap2/tls/ca.crt] \\
ORDERER_GENERAL_CLUSTER_ROOTCAS=[/root/testnet/crypto-config/ordererOrganizations/${aff}/orderers/${name}.${aff}/msp/cacerts/ca.crt,/root/testnet/crypto-config/peerOrganizations/jistap/peers/peer0.jistap/tls/ca.crt,/root/testnet/crypto-config/peerOrganizations/jistap2/peers/peer2.jistap2/tls/ca.crt] \\
