...
async function main() {
    ...
    const revisionNoteID = "".concat('\u0000', 'RN', '\u0000', organization, '\u0000', paperKey, '\u0000', round, '\u0000', reviewerIndex, '\u0000');
    ...
    try {
        ...
        const result = await contract.evaluateTransaction('QueryRevisionNote', revisionNoteID);
