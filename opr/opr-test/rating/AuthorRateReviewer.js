...
exports.main = async function main(user, paperID, reviewerIndexList, ratingList) {
    //const argv = process.argv;
    //const user = argv[2];
    //const organization = argv[3];
    //const paperKey = argv[4];
    //const reviewerIndexList = argv[5];
    //const ratingList = argv[6];
    ...
    try {
        ...
        await contract.submitTransaction('AuthorRateReviewer', paperID, reviewerIndexList, ratingList);
