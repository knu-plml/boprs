...
exports.main = async function main(user, paperID, reviewerIDList, ratingList) {
    //const argv = process.argv;
    //const user = argv[2];
    //const organization = argv[3];
    //const paperKey = argv[4];
    //const reviewerIDList = argv[5];
    ...
    try {
        ...
        await contract.submitTransaction('EOPRateReviewer', paperID, reviewerIDList, ratingList);
