...
exports.main = async function main(user, paperKey, reviewerNum) {
    //const argv = process.argv;
    //const user = argv[2];
    //const organization = argv[3];
    //const paperID = argv[4];
    //const reviewerNum = argv[5];

    //const paperKey = "".concat('\u0000', OI, '\u0000', organization, '\u0000', paperID, '\u0000');
    ...
    try {
        ...
        await contract.submitTransaction('SelectReviewer', paperKey, reviewerNum);
