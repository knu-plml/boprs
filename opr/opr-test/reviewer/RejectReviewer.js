...
exports.main = async function main(user, reviewerKey) {
    //const argv = process.argv;
    //const user = argv[2];
    //const organization = argv[3];
    //const paperID = argv[4];
    //const reviewerIndex = argv[5];

    //const reviewerKey = "".concat('\u0000', 'PR', '\u0000', organization, '\u0000', paperID, '\u0000', reviewerIndex, '\u0000');
    ...
    try {
        ...
        await contract.submitTransaction('RejectReviewer', reviewerKey);
