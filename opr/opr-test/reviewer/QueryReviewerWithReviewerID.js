...
exports.main = async function main(user, reviewerID) {
    //const argv = process.argv;
    //const user = argv[2];
    //const reviewerID = argv[3];
    ...
    try {
        ...
        const result = await contract.evaluateTransaction('QueryReviewerWithReviewerID', reviewerID);
