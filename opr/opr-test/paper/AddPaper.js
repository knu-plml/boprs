...
exports.main = async function main(user, organization, authorID, authorEmail, paperKey, paperTitle, paperAbstract, paperFile) {
    //const argv = process.argv;
    //const user = argv[2];
    //const organization = argv[3];
    //const authorID = argv[4];
    //const authorEmail = argv[5];
    //const paperKey = argv[6];
    ...
    try {
        ...
        await contract.submitTransaction('AddPaper', organization, authorID, paperKey, paperTitle, paperFile, authorEmail, paperAbstract);
