...
exports.main = async function main(user, paperID, paperFile, revisionNote) {
    //const argv = process.argv;
    //const user = argv[2];
    //const organization = argv[3];
    //const paperKey = argv[4];
    //const paperFile = argv[5];
    ...
    try {
        ...
        await contract.submitTransaction('UpdatePaper', paperID, paperFile, revisionNote);
