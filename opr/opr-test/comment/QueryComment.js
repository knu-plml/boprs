...
exports.main = async function main(user, commentKey) {
    //const argv = process.argv;
    //const user = argv[2];
    //const organization = argv[3];
    //const paperID = argv[4];
    //const round = argv[5];
    //const reviewerIndex = argv[6];

    //const commentKey = "".concat('\u0000', 'CR', '\u0000', organization, '\u0000', paperID, '\u0000', round, '\u0000', reviewerIndex, '\u0000');
    ...
    try {
        ...
        const result = await contract.evaluateTransaction('QueryComment', commentKey);
