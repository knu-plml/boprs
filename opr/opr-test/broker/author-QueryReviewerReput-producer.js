...
exports.main = async function main(user, paperKey, reviewerIndexList, rateList, broker) {
    ...
    try {
        ...
        await contract.submitTransaction('AuthorRateReviewer', paperID, reviewerIndexList, rateList);
